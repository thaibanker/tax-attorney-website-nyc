...
export default function EmergencyTaxAttorneyPage() {
  return (
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 max-w-5xl mx-auto">
              ...
              <Card className="bg-white/10 border-white/20">
                <CardContent className="pt-6 text-center text-white">
                  ...
                  <p className="text-sm font-medium">crisis@strategictaxnynj.com</p>
                  <p className="text-sm opacity-90 mt-1">Monitored every 2 hours</p>
                </CardContent>
              </Card>
              <Card className="bg-white/10 border-white/20">
                <CardContent className="pt-6 text-center text-white">
                  <Building className="h-8 w-8 mx-auto mb-3" />
                  <h4 className="font-semibold mb-2">MANHATTAN OFFICE</h4>
                  <p className="text-sm">150 West 25th Street, RM 403</p>
                  <p className="text-sm opacity-90 mt-1">Same-day meetings</p>
                </CardContent>
              </Card>
            </div>
          </div>
